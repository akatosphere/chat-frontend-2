...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group relative flex w-full items-end rounded-md transition-[color,box-shadow] outline-none",
        "min-w-0",
...
function focusInputOnGroupClick(e: React.MouseEvent<HTMLDivElement, MouseEvent>) {
...
function InputGroupAddon({
  ...
  return (
    <div
      ...
      onClick={focusInputOnGroupClick}
      {...props}
    />
  );
}
