...
type ExpiredCodeModalProps = {
  open: boolean;
  onClose: () => void;
};

export const ExpiredCodeModal: React.FC<ExpiredCodeModalProps> = ({ open, onClose }) => (
  <ModalDialog
    overlay="card"
    variant="vertical"
    open={open}
  ...
  >
    <div>
      <AlertDialogHeader>
        <AlertDialogTitle className="title font-medium text-black">
