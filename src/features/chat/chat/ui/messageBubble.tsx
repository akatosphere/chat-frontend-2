...
export const MessageBubble: React.FC<MessageBubbleProps> = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative max-w-[500px] px-3 py-2.5 rounded-2xl flex items-stretch",
          chatMessage.isMine
      ...
      >
        {chatMessage.content && (
          <p className="subtext break-words pr-2">{chatMessage.content}</p>
        )}
        ...
        <div className="h-full flex flex-col justify-end">
          <div className="mt-auto flex items-center gap-0.5 text-xs text-gray">
            <span>{time}</span>
