  ...
  results: [
    ...
    },
    {
      ...
      last_message: {
        ...
        from_user: "2",
        content:
          "Привет. Я оставил две стерманки и два шуруповёрта. Один в кейсе, а др...",
        new: false,
        has_forwarded_message: true,
    ...
    },
    {
      ...
      last_message: {
        ...
        from_user: "me",
        content:
          "Покакал в штаны вчера - это было невероятно. Я кайфанул. Почаще надо заниматься подобным.",
    ...
    },
    {
      ...
      last_message: {
        ...
        uid: "m10",
        from_user: "10",
        content: "Мы поймали голубя и зажарили. Вау! Обязательно угощу вас!",
        new: false,
    ...
    },
    {
      ...
      last_message: {
        ...
        from_user: "me",
        content: "",
        files_summary: { types: ["jpg", "jpg"], count: 2 },
        new: false,
