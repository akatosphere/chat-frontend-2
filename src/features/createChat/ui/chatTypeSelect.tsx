...
export const ChatTypeSelect = () => {
  const { groupOrChannel } = useCreateChatStore();
  ...
  // Находим выбранную опцию. Если в сторе еще старое значение (например, "private-group" в режиме канала),
  // .find вернет undefined, и мы покажем первую доступную опцию для текущего режима.
