...
export const ChatHeader = ({
  ...
  return (
    <header className="flex items-center justify-between px-4 h-[60px] md:border-b md:bg-[#F5F6F8] md:rounded-t-lg">

      <BackButton
        href="/"
        className="w-6 h-6 shrink-0 md:hidden ml-2.5"
        width={12}
        height={20}
      />
...
//       <BackButton href="/" className="w-6 h-6 shrink-0 md:hidden ml-2.5" width={12} height={20}/>
